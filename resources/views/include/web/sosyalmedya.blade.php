    <section class="container text-center mt-0 mt-md-1  d-block d-md-none ">
        <ul class="list-inline">
            @if(cekAyar('twitter')!='')
            <li class="list-inline-item bg-grey p-1"><a class="color-grey p-2" href="https://www.twitter.com/{{cekAyar('twitter')}}" target="_blank"><i
                        class="fab fa-twitter"></i></a></li>
            @endif
            @if(cekAyar('facebook')!='')
            <li class="list-inline-item bg-grey p-1"><a class="color-grey p-2" href="https://facebook.com/{{cekAyar('facebook')}}" target="_blank"><i
                        class="fab fa-facebook"></i></a></li>
                @endif

            @if(cekAyar('instagram')!='')
            <li class="list-inline-item bg-grey p-1"><a class="color-grey p-2" href="https://www.instagram.com/{{cekAyar('instagram')}}" target="_blank" ><i
        ...
        <div class="container text-white topbar">
            ...
            <div class="float-right mr-4">
                <ul class="list-inline p-0 text-center">
                    ...
                    @endif
                    @if(cekAyar('twitter')!='')
                    <li class="list-inline-item a bg-dgreen">
                        <a class="social-item " href="https://www.twitter.com/{{cekAyar('twitter')}}" target="_blank"> <i class="fab fa-twitter"></i> </a>
                    </li>
                        @endif
                        @if (cekAyar('instagram')!='')
