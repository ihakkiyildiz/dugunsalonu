<section class="container text-center mt-4 d-block d-md-none">
    <div>
        <a href="{{route('web.index')}}"><img src="{{cekAyar('logo') ?? asset('/css/img/logo.png')}}" alt="Ana Sayfa"></a>
    </div>
</section>
...
<section class="container text-center mt-4 d-none d-md-block">
    <nav class="navbar navbar-light navbar-expand-md w-100">
        <a href="{{route('web.index')}}" class="navbar-brand"><img src="{{cekAyar('logo') ?? asset('/css/img/logo.png')}}" alt="Ana Sayfa"></a>
        <button class="navbar-toggler navbar-brand border-0 w-100" type="button" data-toggle="collapse" data-target="#NAV" aria-controls="NAV" aria-expanded="false" style="outline:none" aria-label="Gezintiyi Aç">
        ...
        <div id="NAV" class="collapse navbar-collapse text-left mt-3">
            <ul class="navbar-nav list-group fs-10">
                <li class="nav-item active dNavItem">
                    <a href="{{route('web.index')}}" class="nav-link text-uppercase"><i class="fa fa-home mr-1 navIcon"></i> Ana
                        Sayfa</a>
                    <hr class="mt-0 mb-1" />
                </li>
                ...
                <li class="nav-item dNavItem">
                    <a href="hizmetlerimiz.html" class="nav-link text-uppercase"><i class="fa fa-sticky-note mr-2 navIcon"></i>
                        Hizmetlerimiz</a>
                    <hr class="mt-0 mb-1" />
                </li>
                <li class="nav-item dNavItem">
                    <a href="salonlarimiz.html" class="nav-link text-uppercase"><i class="fas fa-images mr-2 navIcon"></i>
                        Salonlarımız</a>
                    <hr class="mt-0 mb-1" />
                </li>
                <li class="nav-item dNavItem">
                    <a href="duyurular.html" class="nav-link text-uppercase"><i class="fa fa-newspaper mr-2 navIcon"></i>
                        Duyurular</a>
                    <hr class="mt-0 mb-1" />
                </li>
                <li class="nav-item dNavItem">
                    <a href="z_defteri.html" class="nav-link text-uppercase"><i class="fas fa-pencil-alt mr-2 navIcon"></i>
                        Z. Defteri</a>
                    <hr class="mt-0 mb-1" />
                </li>
                <li class="nav-item dNavItem">
                    <a href="iletisim.html" class="nav-link text-uppercase"><i class="fa fa-phone-alt mr-2 navIcon"></i>
                        İletişim</a>
                </li>
            </ul>
        </div>
            ...
            <div id="NAV" class="collapse navbar-collapse text-left mt-3">
                <ul class="navbar-nav list-group fs-10">
                    <li class="nav-item active">
                        <a href="{{route('web.index')}}" class="nav-link text-uppercase"><i class="fa fa-home mr-3"></i> Ana
                            Sayfa</a>
                        <hr class="mt-0 mb-1" />
                    </li>
                    <li class="nav-item dropdown dNavItem">
