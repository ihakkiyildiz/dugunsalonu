    ...
    <div class="container my-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12 mb-4">
                ...
                <a><img class="img-fluid z-depth-1" src="{{$salon->image}}" alt="video" data-toggle="modal" data-target="#modal1"></a>
            </div>
                @endforeach
