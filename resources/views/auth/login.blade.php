...
<head>
    ...
    <title>{{cekAyar('site-basligi')}}</title>
                        ...
                        <div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-white">
                            ...
                            <div class="mb-2 text-center">
                                <a class="link-fx font-w700 font-size-h1" href="/">
                                    <span class="text-dark">Ülger</span> <span class="text-primary">Yazılım</span>
                                </a>
                                <p class="text-uppercase font-w700 font-size-sm text-muted">Giriş</p>
                            </div>
                            <!-- END Header -->
                            ...
                            <form class="js-validation-signin" action="{{route('login')}}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="email" class="form-control" id="login-username" name="email" placeholder="example@ulgeryazilim.com">
